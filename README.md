...
1. 관심사별로 폴더가 존재 (basic / blockchain / designPattern / problem ...)
2. 폴더 추가시 tsconfig > include 배열에 경로 추가
3. package.json > start 커맨드의 경로 수정
...
- Tsc watch를 설치하면 좀 더 원활한 개발 가능 => 스크립트를 단순화해주는 역할을 하는듯 (+a는 추후에)  
