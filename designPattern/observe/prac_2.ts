...
magazineCorpSystem.updateMagazineCorpProductInfo(399900,["horror","action","comic"])
...
magazineCorpSystem.updateMagazineCorpProductInfo(20,["horror","action","comic","comic","comic","comic","comic","comic","comic"]);   


console.log('-----');
console.log('자신이 구독취소하자마자 혜택이 좋아진걸 발견한 BadUser는 오열합니다.');
console.log('-----');